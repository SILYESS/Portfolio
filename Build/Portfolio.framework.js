...
var ASM_CONSTS = {
  7536704: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 7536759: ($0) => { performance.now = function() { return $0; }; },  
 7536807: ($0) => { performance.now = function() { return $0; }; },  
 7536855: () => { performance.now = Module['emscripten_get_now_backup']; }
};
